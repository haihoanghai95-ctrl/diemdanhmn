...
export default function Reports({ students, classrooms, attendance, settings, isTeacher = false }: ReportsProps) {
  ...
  return (
    <div className="space-y-6">
      {/* 1. Header Row */}
      <div className="no-print flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xs">
        <div>
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xs flex flex-col gap-6" id="monthly-summary-section">
        ...
        {/* Filter / Search input */}
        <div className="flex flex-col sm:flex-row items-center gap-4 bg-slate-50/50 dark:bg-slate-850/20 p-4 rounded-xl border border-slate-100 dark:border-slate-800/80">
